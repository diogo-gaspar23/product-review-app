...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.PUT, "/reviews/**/vote").hasRole(Role.RegisteredUser)
                .antMatchers(HttpMethod.GET, "/reviews/pendingreview").hasRole(Role.Mod)
                .antMatchers(HttpMethod.PUT, "/reviews/acceptrejectreview/**").hasRole(Role.Mod)
